...
void HMC5883Init(void)
{
    ...
    Single_Write(0x3C, 0x00, 0xF8);
    Single_Write(0x3C, 0x01, 0x00);
...
void ReadHMC5883(short *pcompass)
{
  ...
  compassbuff[1] = Single_Read(0x3C, 0x03);
  compassbuff[0] = Single_Read(0x3C, 0x04);

  pcompass[0] = ((compassbuff[1]<<8)|compassbuff[0]);
  compassbuff[1] = Single_Read(0x3C, 0x05);
  compassbuff[0] = Single_Read(0x3C, 0x06);
  pcompass[2] = ((compassbuff[1]<<8)|compassbuff[0]);
  compassbuff[1] = Single_Read(0x3C, 0x07);
  compassbuff[0] = Single_Read(0x3C, 0x08);
