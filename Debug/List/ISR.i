...
void EXTI15_10_IRQHandler()
{
  ...
  if(EXTI_GetITStatus(((uint32_t)0x04000))!=RESET)
  {
    ...
    ((0) ? (void)0 : ( __aeabi_assert("0", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\APP\\src\\ISR.c", 73), ( __iar_EmptyStepPoint())));
}
char nrf_int_flag = 1;          
void EXTI9_5_IRQHandler()
{
  ...
  if(EXTI_GetITStatus(((uint32_t)0x00100))!=RESET)
  {
    ...
    (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b12) = (~(((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b12));
    nrf_int_flag = 0;                   
...
void USART3_IRQHandler(void)
{
  ...
  {
    Uart1_RevBuf[Uart1_RevBuf_Tail] = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)));    
    if(usart_GPS_sd_flag)
      USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), Uart1_RevBuf[Uart1_RevBuf_Tail]);
    Uart1_RevBuf_Tail++;
    if(Uart1_RevBuf_Tail > 256-1)
      Uart1_RevBuf_Tail = 0;    
  }
  if(USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)),((uint16_t)0x0424))!= RESET)
  {
    sCom.RecvLen = (uint32)sizeof(sCom.RecvBuf) - ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030))->CNDTR;
    if(dma_max_recieve<sCom.RecvLen)
      dma_max_recieve = sCom.RecvLen;
    ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030))->CCR &= ~((uint16_t)0x0001);  
    ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000))->IFCR |= ((uint32_t)0x00000100);       
    ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030))->CNDTR = (uint32)sizeof(sCom.RecvBuf);  
    ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030))->CCR |= ((uint16_t)0x0001);  
    
    if(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->SR & (((uint16_t)0x0004) | ((uint16_t)0x0002) | ((uint16_t)0x0001)))  
    {
    }
    else
    {
    ...
    uint32 sr = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->SR;  
    uint32 dr = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR;  
...
void DMA1_Channel3_IRQHandler(void)
{
  ...
  DMA_ClearITPendingBit(((uint32_t)0x00000800));
  DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030)), DISABLE); 
  ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030))->CNDTR = 1024;
  DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030)), ENABLE);
}
