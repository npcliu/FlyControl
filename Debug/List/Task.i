...
PROCEDURE TaskInit(PROCEDURE (*_Task[MAX_TASK_NUM])(char))
{
  ((stb_pre>=0 && stb_pre<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("stb_pre>=0 && stb_pre<MAX_TASK_NUM", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\APP\\src\\Task.c", 288), ( __iar_EmptyStepPoint())));
  _Task[stb_pre] = StbPrep;                        
  ((standby>=0 && standby<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("standby>=0 && standby<MAX_TASK_NUM", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\APP\\src\\Task.c", 290), ( __iar_EmptyStepPoint())));
  _Task[standby] = Standby;
  ((att_hld_pre>=0 && att_hld_pre<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("att_hld_pre>=0 && att_hld_pre<MAX_TASK_NUM", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\APP\\src\\Task.c", 292), ( __iar_EmptyStepPoint())));
  _Task[att_hld_pre] = AttHldPrep;
  ((att_hld>=0 && att_hld<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("att_hld>=0 && att_hld<MAX_TASK_NUM", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\APP\\src\\Task.c", 294), ( __iar_EmptyStepPoint())));
  _Task[att_hld] = AttHld;
  ((set_para_pre>=0 && set_para_pre<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("set_para_pre>=0 && set_para_pre<MAX_TASK_NUM", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\APP\\src\\Task.c", 296), ( __iar_EmptyStepPoint())));
  _Task[set_para_pre] = SetParaPre;
  ((set_para>=0 && set_para<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("set_para>=0 && set_para<MAX_TASK_NUM", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\APP\\src\\Task.c", 298), ( __iar_EmptyStepPoint())));
  _Task[set_para] = SetParam;           
  ((experiment_pro>=0 && experiment_pro<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("experiment_pro>=0 && experiment_pro<MAX_TASK_NUM", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\APP\\src\\Task.c", 300), ( __iar_EmptyStepPoint())));
