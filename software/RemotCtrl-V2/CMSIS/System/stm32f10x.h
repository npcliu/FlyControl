...
typedef struct
{
  __IO uint32_t CCR;    //DMA channel x configuration register (DMA_CCRx) 
  __IO uint32_t CNDTR;  //DMA channel x number of data register (DMA_CNDTRx) 
  __IO uint32_t CPAR;   //DMA channel x peripheral address register (DMA_CPARx) 
  __IO uint32_t CMAR;   //DMA channel x memory address register (DMA_CMARx) 
} DMA_Channel_TypeDef;
