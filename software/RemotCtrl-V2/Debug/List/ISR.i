...
void TIM4_IRQHandler(void) 
{
  ...
  if(irq_count>=100000)
    irq_count = 0;
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b8) = 0;
  ...
  if(0==irq_count%10)           
  {
    ...
    TIM_SetCompare3(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)),1000);  
  }
  switch(irq_count%100)         
  {
  case 0:
    {
    pit_500ms_flag = 1;
      flag500ms_time++;
      if(flag500ms_time>=10)             
      {
        flag500ms_time = 0;
        pit_5s_flag = 1;
      }
  ...
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b8) = 1;
}
...
void EXTI15_10_IRQHandler()
{
  ...
  else if(EXTI_GetITStatus(((uint32_t)0x08000))!=RESET)      
  {
    if((((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->IDR)))->b6))
    {
      encoder++;
    }
    else
  ...
  else if(EXTI_GetITStatus(((uint32_t)0x00800))!=RESET)
  {
     if(plane_mod != experiment)
        plane_mod += 1;
      else 
        plane_mod = lock;
      EXTI_ClearITPendingBit(((uint32_t)0x00800));              
  }
  else if(EXTI_GetITStatus(((uint32_t)0x01000))!=RESET)      
  {
     if(key2_press_time > 400){
      key2_press_time = 0;
      if(irq_tx_buff[0] == 'e'){
        start_expriment_flag += 1;       
    ...
    EXTI_ClearITPendingBit(((uint32_t)0x01000));
  }
  else
    while(1);
}
