...
{
  gpio_init(PE14,GPIO_Mode_Out_OD,n_interupt,GPIO_Speed_50MHz,1);						 
  gpio_init(PE15,GPIO_Mode_Out_OD,n_interupt,GPIO_Speed_50MHz,1);						 
}

void IIC_Start(void)    
{
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->CRH)))->fb7) = LJL_OOD;     
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b15)=1;
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b14)=1;
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b15)=0;
}
...
{
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->CRH)))->fb7) = LJL_IFLT;      
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b14) = 1;
  while((((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->IDR)))->b15))
    delay_us(2);
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b14)=0;             
...
void IIC_Send_Byte(uint8 txd)           
{
  ...
  for(t=0;t<8;t++)
  {
    (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b15) = ((txd&0x80)!=0);
    txd<<=1;
    (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b14)=1;
    (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b14)=0;
  }
...
uint8 IIC_Read_Byte(uint8 ack)          
{
  ...
  for(i=0;i<8;i++ )
  {
    ...
    (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->ODR)))->b14)=1;
    receive<<=1;
    if((((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))->IDR)))->b15))
      receive++;     
  }
  if (!ack)
    IIC_NAck();             
...
void Single_Write(uint8 slave_addr, uint8 reg_addr, uint8 data)		     
{
  IIC_Start();                  
...
void CompassInit(void)
{
  ...
  for(i=0; i<4; ++i)
    Single_Write(0x1A, param[i][0], param[i][1]);
}
...
{
  uint8 buff[2] = {0};
  Single_Read(0xee,bmp085_RCOMMAND,buff+1);
  Single_Read(0xee,bmp085_RCOMMAND+1,buff);
...
short bmp085ReadTemp(void)
{
  ...
  Single_Read(0xee,0xF6,buff+1);
  Single_Read(0xee,0xF6+1,buff);
