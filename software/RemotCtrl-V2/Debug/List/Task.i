...
typedef struct
{
  ...
  float value;
  char ins[50];        
  PANNELD_DATA dis_ifo;                
}PARAMETER;




extern PARAMETER params[10];
...
void LCD_Show_Para(int cursur, int selected_para);             
...
char first_cycl = 1;
char unlock_flag = 0;
uint8 start_expriment_flag = 0x0;

PROCEDURE StbPrep(char input)
{
  lcd.bcolr = (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3));
  Gpio8080OptLcdClr(lcd.bcolr);
  EXTIEnable(((uint32_t)0x04000));             
  EXTIEnable(((uint32_t)0x08000));             
  EXTIEnable(((uint32_t)0x01000));
  irq_tx_buff[0] = 'l';    
  irq_tx_buff[1] = 0;
  irq_tx_buff[2] = 0;
  irq_tx_buff[3] = 0;
  ...
  lcd.pcolr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)192 & 0xFC) << 3) | ((uint16)203 >> 3));
  ...
  printf("Unlock Plane:");
  lcd.pcolr = last_color;
  printf("Keep throttle at 0 and turn it ");  lcd.pcolr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3));  printf("Right;\n");
  lcd.pcolr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)192 & 0xFC) << 3) | ((uint16)203 >> 3));
  printf("Lock Plane:");
  lcd.pcolr = last_color;
  printf("Keep throttle at 0 and turn it ");  lcd.pcolr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3));  printf("Left;\n");
...
uint32 timetstcount;
uint32 endval[5];
uint32 photo_res_voltage = 0;          

PROCEDURE Standby(char input)           
{
  if(rlud==lcd.scan_dir)
  {
    th_adc = 4095 - GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),10);
    dr_adc = 4095 - GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),11);
    ud_adc = 4095 - GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),12);
    lr_adc = 4095 - GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),13);
  }
  else if(lrdu==lcd.scan_dir)
  {
    th_adc = GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),10);
    dr_adc = GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),11);
    ud_adc = GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),12);
    lr_adc = GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),13);
  }
  else;
  ...
  DrawThLine(&th_lcd_info,(u16)(((float)th_adc/4095)*(lcd.scrn_x-24)),1);
    ...
    UpdateRmtCtrlStatus(nrf_tx_sta,1,(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
    UpdatePlaneMod(plane_mod,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)165 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
    pit_50ms_flag = 0;
  }
  
  irq_tx_buff[1] = th_adc>>4;       
  irq_tx_buff[2] = dr_adc>>4;
  irq_tx_buff[3] = ud_adc>>4;
  irq_tx_buff[4] = lr_adc>>4;
  
  static uint32 tstcount = 0;
  if(confirm_flag)
  {
    tstcount++;
    irq_tx_buff[2] = tstcount;
  ...
  if(irq_tx_buff[8] != 'z')
    irq_tx_buff[8] = 't'; 
  if(ud_adc<510 && lr_adc>(3200))
  {
      irq_tx_buff[8] = 'z'; 
      LcdSS(120,10,c1206, "Send the data", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
  }
  else
  {
     LcdSS(120,10,c1206, "                           ", (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
  }
...
{
  EXTIDisable(((uint32_t)0x04000));
  EXTIDisable(((uint32_t)0x08000));
  EXTIDisable(((uint32_t)0x01000));
  lcd.bcolr = (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)35 >> 3));
  Gpio8080OptLcdClr(lcd.bcolr);
...
PROCEDURE AttHld(char input)
{
  ...
  nrf_tx(irq_tx_buff,32);      
  UpdateRmtCtrlStatus(nrf_tx_sta,1,(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)),lcd.bcolr);
  UpdatePlaneMod(plane_mod,(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)),lcd.bcolr);
...
static int last_cursor = 3,cursor = 3;        
static short parameter_pointer = 3,last_parameter_pointer = 3;
uint16 norm_lr_adc,norm_ud_adc;
...
DelayMs(10);            
  ...
  for(i=0;i<10;++i)
  {
    strcpy((char*)irq_tx_buff,"FEParamGet");             
    strcat((char*)irq_tx_buff,params[i].name);             
    waite_for_nrf_data = 1;
    nrf_tx(irq_tx_buff,32);
    DelayMs(20);
    nrf_rx_mode();
    while(waite_for_nrf_data);            
  ...
  DelayMs(1000);
  LCD_Show_Para(last_cursor,last_parameter_pointer);             
  irq_tx_buff[0] = 'p';    
  return set_para;
}
...
PROCEDURE SetParam(char input)           
{
  ...
  else if(encoder)
  {
    ...
    if(cursor<0 || cursor>7)
    {
      ...
      {
        LCD_Fill(sx, ex, 0, 64, params[i].dis_ifo.pan.colr);                       
    ...
    else
    {
      ...
      LCDDrawPointer(cursor*30+poitr_off_pan, 64+4, 9, 3,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)255 >> 3)));
    }
    if(cursor<0)
      cursor=0;
    else if(cursor>7)
...
DATA_ON_LCD thr_data_on_lcd = {.x=120, .y=250, .last_length = 0, .size = c1206, .data_color = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)), .unit_color = (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3))};
extern int expriment_time;
PROCEDURE ExperimentProcedure(char input){
  ...
  if(first_cycl)
  {
    ...
    if(pit_50ms_flag)
    {
        ...
        if(unlock_flag == 1)
        {
          LcdSS(lcd.scrn_x-c1206,c1206/2*strlen("Mode:experiment "),c1206, " Unlocked", (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)), (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
          if(start_expriment_flag)
          {
              
              irq_tx_buff[8] = 'k'; 
              LcdSS(100,10,c1206, "Start the experiment", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
            ...
            irq_tx_buff[3] = ud_adc>>4;
            irq_tx_buff[4] = lr_adc>>4;
            LcdSS(100,10,c1206, "Stop the experiment", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
          }
        }
        else 
          LcdSS(lcd.scrn_x-c1206,c1206/2*strlen("Mode:experiment "),c1206, "   locked", (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)), (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
      pit_50ms_flag = 0;
    }
      ...
      UpdateRmtCtrlStatus(nrf_tx_sta,1,(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
      UpdatePlaneMod(plane_mod,(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)));
    if(plane_mod == lock){
...
PROCEDURE TaskInit(PROCEDURE (*_Task[MAX_TASK_NUM])(char))   
{
  ((stb_pre>=0 && stb_pre<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("stb_pre>=0 && stb_pre<MAX_TASK_NUM", "E:\\FlyCtrl\\CTRL_PCBV5 (github)\\FlyControl\\software\\RemotCtrl-V2\\User\\src\\Task.c", 589), ( __iar_EmptyStepPoint())));
  _Task[stb_pre] = StbPrep;
  ((standby>=0 && standby<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("standby>=0 && standby<MAX_TASK_NUM", "E:\\FlyCtrl\\CTRL_PCBV5 (github)\\FlyControl\\software\\RemotCtrl-V2\\User\\src\\Task.c", 591), ( __iar_EmptyStepPoint())));
  _Task[standby] = Standby;
  ((att_pre>=0 && att_pre<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("att_pre>=0 && att_pre<MAX_TASK_NUM", "E:\\FlyCtrl\\CTRL_PCBV5 (github)\\FlyControl\\software\\RemotCtrl-V2\\User\\src\\Task.c", 593), ( __iar_EmptyStepPoint())));
  _Task[att_pre] = AttHldPrep;
  ((att_hld>=0 && att_hld<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("att_hld>=0 && att_hld<MAX_TASK_NUM", "E:\\FlyCtrl\\CTRL_PCBV5 (github)\\FlyControl\\software\\RemotCtrl-V2\\User\\src\\Task.c", 595), ( __iar_EmptyStepPoint())));
  _Task[att_hld] = AttHld;
  ((set_para_pre>=0 && set_para_pre<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("set_para_pre>=0 && set_para_pre<MAX_TASK_NUM", "E:\\FlyCtrl\\CTRL_PCBV5 (github)\\FlyControl\\software\\RemotCtrl-V2\\User\\src\\Task.c", 597), ( __iar_EmptyStepPoint())));
  _Task[set_para_pre] = SetParaPre;
  ((set_para>=0 && set_para<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("set_para>=0 && set_para<MAX_TASK_NUM", "E:\\FlyCtrl\\CTRL_PCBV5 (github)\\FlyControl\\software\\RemotCtrl-V2\\User\\src\\Task.c", 599), ( __iar_EmptyStepPoint())));
  _Task[set_para] = SetParam;
  ((experiment_pro>=0 && experiment_pro<MAX_TASK_NUM) ? (void)0 : ( __aeabi_assert("experiment_pro>=0 && experiment_pro<MAX_TASK_NUM", "E:\\FlyCtrl\\CTRL_PCBV5 (github)\\FlyControl\\software\\RemotCtrl-V2\\User\\src\\Task.c", 601), ( __iar_EmptyStepPoint())));
