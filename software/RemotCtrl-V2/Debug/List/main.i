...
PARAMETER params[10] = {        
  ...
  {.name="xpo",.value=0.5,.ins="Attitude out loop P of x aix;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3))}, 
  {.name="xpi",.value=0.5,.ins="Attitude inner loop P of x aix;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)224 >> 3))},
  {.name="xdi",.value=0.5,.ins="Attitude inner loop D of x aix;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)128 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3))},
  {.name="ypo",.value=0.5,.ins="Attitude out loop P of y aix;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)248 & 0xF8) << 8) | (((uint16)248 & 0xFC) << 3) | ((uint16)255 >> 3))},
  {.name="ypi",.value=0.5,.ins="Attitude inner loop P of y aix;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)221 & 0xF8) << 8) | (((uint16)160 & 0xFC) << 3) | ((uint16)221 >> 3))},
  {.name="ydi",.value=0.5,.ins="Attitude inner loop D of y aix;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)153 & 0xF8) << 8) | (((uint16)50 & 0xFC) << 3) | ((uint16)204 >> 3))},
  {.name="Bx",.value=0.5,.ins="Basic balance of X axis;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)238 & 0xF8) << 8) | (((uint16)130 & 0xFC) << 3) | ((uint16)238 >> 3))},
  {.name="By",.value=0.5,.ins="Basic balance of Y axis;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)255 >> 3))},
  {.name="N",.value=0.5,.ins="Derivative coefficient;",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)255 >> 3))},
  {.name="Ind",.value=0.5,.ins="Complementary filter index",.dis_ifo.pan_dat.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),.dis_ifo.pan.colr = (uint16)((((uint16)119 & 0xF8) << 8) | (((uint16)136 & 0xFC) << 3) | ((uint16)153 >> 3))}
...
int main(void)
{
  ...
  gpio_init(PC11,GPIO_Mode_Out_PP,n_interupt,GPIO_Speed_50MHz,0);
  gpio_init(PA8,GPIO_Mode_Out_PP,n_interupt,GPIO_Speed_50MHz,0);
    gpio_init(PD9,GPIO_Mode_IPU,n_interupt,GPIO_Speed_50MHz,0);
  GpioInit();
  DelayMs(50);
  if((((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))->IDR)))->b12))                   
    lcd.scan_dir = rlud;        
  else
    lcd.scan_dir = lrdu;        
  ...
  th_lcd_info.colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3));                
  th_lcd_info.x_len = 0;
  th_lcd_info.y_len = 1;                           
  ...
  dr_lcd_info.colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3));                
  dr_lcd_info.x_len = 1;
  dr_lcd_info.y_len = 0;                           
  ...
  ud_lcd_info.colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3));                
  ud_lcd_info.x_len = 0;
  ud_lcd_info.y_len = 2;                           
  ud_lcd_info.sx = center[0];
    ud_lcd_info.sy = center[1];
  lr_lcd_info.colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3));                
  lr_lcd_info.x_len = 2;
  lr_lcd_info.y_len = 0;                           
  ...
  bty_votg_lcd_info.x=0;                        
  bty_votg_lcd_info.y=lcd.scrn_y - 7;
  bty_votg_lcd_info.acr_desm = 2;

  bty_votg_lcd_info.size=c1206;
  bty_votg_lcd_info.data_colr=(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3));
  bty_votg_lcd_info.unit_colr = (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3));
  int i = 0;
  for(i=0;i<10+2;i++)               
  ...
  nrf_send_times.data_colr = (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3));
  nrf_send_times.unit_colr = (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3));
  ...
  LCDDrawPointer(100,40, 5,0,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)));
  LCDDrawPointer(101,39, 5,1,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)));
  LCDDrawPointer(102,40, 5,2,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)));
  LCDDrawPointer(101,41, 5,3,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)));

  NVIC_Config();
  Gpio8080OptLcdClr(lcd.bcolr);
  LcdDrawLine(10,0,0,1,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)));
  LcdDrawLine(239,0,100,2,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)));
