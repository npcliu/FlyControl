...
int nmea_parser_init(nmeaPARSER *parser)
{
    ...
    ((parser) ? (void)0 : ( __aeabi_assert("parser", "E:\\Elec\\Air plane\\FlyCtrl\\RemotCtrl-V2\\nmealib\\src\\parser.c", 44), ( __iar_EmptyStepPoint())));
...
void nmea_parser_destroy(nmeaPARSER *parser)
{
    ((parser && parser->buffer) ? (void)0 : ( __aeabi_assert("parser && parser->buffer", "E:\\Elec\\Air plane\\FlyCtrl\\RemotCtrl-V2\\nmealib\\src\\parser.c", 67), ( __iar_EmptyStepPoint())));
    free(parser->buffer);
