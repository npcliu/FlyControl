...
{
  uint8 port;           
  uint8 which_port_s_RCC = 0;   
  uint8 pin_offset = 0;
  uint8 ctrl_reg_offset = 0;
  GPIO_TypeDef * port_to_portADDR = 0; 
  
  port = pin/16;        
  which_port_s_RCC = (0==port)*((uint32_t)0x00000004)+(1==port)*((uint32_t)0x00000008)+(2==port)*((uint32_t)0x00000010)+(3==port)*((uint32_t)0x00000020)+(4==port)*((uint32_t)0x00000040);
  switch(port)
  {
  case 0:
    {
      port_to_portADDR = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800));
    }break;
  case 1:
    {
      port_to_portADDR = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00));
    }break;
  case 2:
    {
      port_to_portADDR = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000));
    }break;
  case 3:
    {
      port_to_portADDR = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400));
    }break;
  case 4:
    {
      port_to_portADDR = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800));
    }break;
  default:break;
  }
  pin_offset = pin%16;
  ...
  if(interupt_flag)                     
    RCC_APB2PeriphClockCmd(which_port_s_RCC|((uint32_t)0x00000001), ENABLE);	 
  else                                  
    
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR |= which_port_s_RCC; 
  ...
  port_to_portADDR->ODR |= (initial_level<<pin_offset);         
...
void gpio_int_cfg(PTXn_e pin,uint32_t EXTI_Line,uint8 EXTI_Trigger)
{
  ...
  GPIO_EXTILineConfig(port,pin%16);
  
  tmp = (uint32_t)((((uint32_t)0x40000000) + 0x10000) + 0x0400);
  
  
   
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR &= ~EXTI_Line;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->EMR &= ~EXTI_Line;
  
  tmp += EXTI_Mode_Interrupt;
  
  *(volatile uint32_t *) tmp |= EXTI_Line;
  
   
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR &= ~EXTI_Line;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTSR &= ~EXTI_Line;
...
{
  uint32_t tmp = 0;
  uint32 pin_offset = GPIO_PinSource;
  int i = 0;
  ...
  if(pin_offset<4)
  {
    for(i=0;i<4;i++)
    {
      if(GPIO_PortSource&(1<<i))
        ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[0] |= 1<<((pin_offset<<2) + i);
      else
        ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[0] &= ~(1<<((pin_offset<<2) + i));
    }
  }
  ...
  else
  {
    ...
    ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[pin_offset >> 0x02] &= ~tmp;
    ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[pin_offset >> 0x02] |= (((uint32_t)GPIO_PortSource) << (0x04 * (pin_offset & (uint8_t)0x03)));
  }
}
