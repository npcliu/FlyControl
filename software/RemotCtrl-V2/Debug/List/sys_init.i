...
void ReadCompass();
extern void Single_Write(unsigned char slave_addr, unsigned char reg_addr, unsigned char data);		     
...
void GpioInit(void)
{
  ...
  gpio_init(PC13,GPIO_Mode_Out_OD,n_interupt,GPIO_Speed_50MHz,0);
  
  
  
  
  gpio_init(PD14,GPIO_Mode_IPU,interupt,GPIO_Speed_50MHz,1);						 
  gpio_int_cfg(PD14,((uint32_t)0x04000),EXTI_Trigger_Falling);
  
  gpio_init(PD15,GPIO_Mode_IPU,interupt,GPIO_Speed_50MHz,1);
  gpio_int_cfg(PD15,((uint32_t)0x08000),EXTI_Trigger_Falling);
  gpio_init(PC6,GPIO_Mode_IPU,n_interupt,GPIO_Speed_50MHz,1);						 
  
  
  
  gpio_init(PD12,GPIO_Mode_IPU,interupt,GPIO_Speed_50MHz,1);						 
  gpio_int_cfg(PD12,((uint32_t)0x01000),EXTI_Trigger_Falling);
  
  gpio_init(PD11,GPIO_Mode_IPU,interupt,GPIO_Speed_50MHz,1);						 
  gpio_int_cfg(PD11,((uint32_t)0x00800),EXTI_Trigger_Falling);
...
float FiltedBatVoltage()
{
  static uint16 bat[10] = {0};
  static int pointer = 0;
  static float voltsum = 0;
  float filted_data = 0;
  
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b1) = 1;
  ...
  if(pointer<10-1)
    ...
    pointer = 0;
  voltsum -= bat[pointer];
  bat[pointer] = GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),0);
  voltsum += bat[pointer];
  filted_data = voltsum/10;
  
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b1) = 0;
  
  return filted_data/(4095+1)*5.086666;   
}
uint32 PhotoRESVoltageGet()
{
  uint16 adc_val = 0;
  
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b2) = 0;
  delay_us(50);                
  adc_val = GetAdc(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)),3);         
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b2) = 1;
...
uint8 SPI_ExchangeByte(uint8 input)
{
  SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), input);
...
void Adc1Init(void)
{
  gpio_init(PA2,GPIO_Mode_Out_OD,n_interupt,GPIO_Speed_50MHz,0);					 
  gpio_init(PA1,GPIO_Mode_Out_PP,n_interupt,GPIO_Speed_50MHz,0);					 
  gpio_init(PC0,GPIO_Mode_AIN,n_interupt,GPIO_Speed_50MHz,0);						 
  gpio_init(PC1,GPIO_Mode_AIN,n_interupt,GPIO_Speed_50MHz,0);						 
  gpio_init(PC2,GPIO_Mode_AIN,n_interupt,GPIO_Speed_50MHz,0);						 
...
u16 GetAdc(ADC_TypeDef* ADCx,u8 ch)
{    
  ADC_RegularChannelConfig(ADCx, ch, 1, ((uint8_t)0x07));
  ADC_SoftwareStartConvCmd(ADCx, ENABLE);    
  while(!ADC_GetFlagStatus(ADCx, ((uint8_t)0x02)));    
...
void LCD_Show_Para(int cursur, int selected_para)             
{
  uint8 i = 0;
  uint16 sx= 1,ex = 29;
  LCD_Fill(0, 30, lcd.scrn_y-64, lcd.scrn_y, (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)255 >> 3)));                   
  LCD_Fill(lcd.scrn_x-30,lcd.scrn_x, lcd.scrn_y-64, lcd.scrn_y, (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)255 >> 3)));           
  ...
  LcdSS(239-22,320-64+8,c1608,"Return", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)255 >> 3)));
  LcdSS(8,320-64+8,c1608,"Adjust", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),(uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)255 >> 3)));
  LCDDrawPointer(cursur*30+poitr_off_pan, 64+4,9, 3,(uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)255 >> 3)));
...
void UpdateRmtCtrlStatus(nrf_tx_state_e _tx_flag,uint8 force_update,u16 pcolor,u16 bcolor)
{
  ...
  if(!force_update)
    if(last_tx_flag==_tx_flag || NRF_TXING==_tx_flag)     
      return ;
  
  LcdSS(lcd.scrn_x-c1206,160,c1206,"RF link:", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)),bcolor);
  if(NRF_TX_OK==_tx_flag)
    LcdSS(lcd.scrn_x-c1206,160+c1206/2*strlen("RF link:"),c1206,"  Good  ", (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)),bcolor);
  else if(NRF_TX_TIME_OUT==_tx_flag)
    LcdSS(lcd.scrn_x-c1206,160+c1206/2*strlen("RF link:"),c1206,"   Bad  ", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),bcolor);
  else
    LcdSS(lcd.scrn_x-c1206,160+c1206/2*strlen("RF link:"),c1206,"Not know", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),bcolor);
  last_tx_flag = _tx_flag;
}

void UpdatePlaneMod(const PLANE_MODE _mode,u16 pcolor,u16 bcolor)
{
  LcdSS(lcd.scrn_x-c1206,c1206/2,c1206, "Mode:", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)255 & 0xFC) << 3) | ((uint16)0 >> 3)),bcolor);
  
  switch(_mode)
  {
  case lock:
    {
      LcdSS(lcd.scrn_x-c1206,c1206/2*strlen("Mode:")+c1206/2,c1206, "Lock", (uint16)((((uint16)255 & 0xF8) << 8) | (((uint16)0 & 0xFC) << 3) | ((uint16)0 >> 3)),bcolor);
    }break;
  case fly:
    {
      LcdSS(lcd.scrn_x-c1206,c1206/2*strlen("Mode:")+c1206/2,c1206, "Hold Attitude", (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)), bcolor);
    }break;
  case height_fix:
    {
      LcdSS(lcd.scrn_x-c1206,c1206/2*strlen("Mode:")+c1206/2,c1206, "Hold Height", (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)), bcolor);
    }break;
  case experiment:
    {
       LcdSS(lcd.scrn_x-c1206,c1206/2*strlen("Mode:"),c1206, "experiment", (uint16)((((uint16)0 & 0xF8) << 8) | (((uint16)128 & 0xFC) << 3) | ((uint16)0 >> 3)), bcolor);
    }break;
  default:break;
  }
}
