...
#include <common.h>     //DXG

#define PxIFLT         0x44444444;             //all 8 pin input ;manual P171
#define PxIPU          0x88888888;             //all 8 pin input ;manual P171
#define PxOUTPP         0x33333333;             //all 8 pin output ;manual P171
...
#define DWB(X,REG)         (((_32type*)(&(GPIO##X->REG)))->DW)//four bit
...
void gpio_int_cfg(PTXn_e pin,uint32_t EXTI_Line,uint8 EXTI_Trigger);//EXTITrigger_TypeDef
