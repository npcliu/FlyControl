...
//输入参数:freq：PWM频率
//         duty：占空比
//例：  TIM1输出1000HzPWM，脉宽设置范围 0-10000，输出占空比5000/10000=50%
//TIM1_PWM_Init(1000,10000，5000);
void TIM1_PWM_Init(u32 freq ,u16 scope,int duty)
{
  ...
  //引脚功能配置
//GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10; //TIM1_CH1 TIM1_CH2
//  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;          //复用推挽输出！！
//  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
//  GPIO_Init(GPIOA, &GPIO_InitStructure);
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15; //TIM1_CH1 TIM1_CH2
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;          //复用推挽输出！！
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  ...
  //初始化TIM1 Channel1、Channel2 PWM模式	 
...
//  TIM_OCInitStructure.TIM_Pulse = duty;
//  TIM_OC4Init(TIM1, &TIM_OCInitStructure);  //根据T指定的参数初始化外设TIM2 OC2
...
//  TIM_OC2PreloadConfig(TIM1, TIM_OCPreload_Enable);  //使能TIM2在CCR2上的预装载寄存器
  TIM_OC3PreloadConfig(TIM1, TIM_OCPreload_Enable);  //使能TIM2在CCR2上的预装载寄存器
//  TIM_OC4PreloadConfig(TIM1, TIM_OCPreload_Enable);  //使能TIM2在CCR2上的预装载寄存器
  TIM_CtrlPWMOutputs(TIM1, ENABLE);                     //高级定时器timer1和timer8需要这句
...
//输入参数:freq：PWM频率
//         duty：占空比
//例：  TIM2输出1000HzPWM，脉宽设置范围 0-10000，输出占空比5000/10000=50%
//TIM2_PWM_Init(1000,10000，5000);
...
void Tim2PwmInit(u32 frequency,u16 duty)
{
