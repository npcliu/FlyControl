...
void SaveToFlash()
{
  ...
  FlashWriteAddr = 0x0803F800;
  FLASH_ProgramHalfWord((uint32_t)FlashWriteAddr + 0, gyro.x_offset);
  FLASH_ProgramHalfWord((uint32_t)FlashWriteAddr + 2, gyro.y_offset);
  FLASH_ProgramHalfWord((uint32_t)FlashWriteAddr + 4, gyro.z_offset);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 8, *(uint32*)&acc.kx);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 12, *(uint32*)&acc.ky);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 16, *(uint32*)&acc.kz);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 20, *(uint32*)&acc.x_off);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 24, *(uint32*)&acc.y_off);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 28, *(uint32*)&acc.z_off);
  
  FLASH_ProgramHalfWord((uint32_t)FlashWriteAddr + 32, compass.x_offset);
  FLASH_ProgramHalfWord((uint32_t)FlashWriteAddr + 34, compass.y_offset);
  FLASH_ProgramHalfWord((uint32_t)FlashWriteAddr + 36, compass.z_offset);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 38, *(uint32*)&compass.kx);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 42, *(uint32*)&compass.ky);
  FLASH_ProgramWord((uint32_t)FlashWriteAddr + 46, *(uint32*)&compass.kz);
  FLASH_Lock();
}
...
char AccCalibration(PACC pacc,PGYRO pgyro)
{
  ...
  float sum = 0;
  uint32 count = 0;
  char axis_to_cali_flag = 0;        
  char step = 20;
  float _1g_value = 1.0/(0.00048830f);     
  int a_t_v = (int)(_1g_value*(1-xyz_t));           
  int r_t_v = (int)(_gt/(0.0610370f));        
  ...
  while(1)
  {
    ...
    {
      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b10) = 0;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b11) = 0;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b12) = 0;
      DelayMs(100);
      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b10) = 1;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b11) = 1;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b12) = 1;
      sum = 0;
      count = 0;
      continue;                         
    }
    if(_acc_adc.x>a_t_v && end_max_of_axis[0])            
    {
      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b10) = 0;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b11) = 1;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b12) = 1;
      sum += _acc_adc.x;
      count++;
      axis_to_cali_flag = 0;
      step = 0;
    ...
    {
      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b10) = 1;
      count = 0;
      sum = 0;
      step = 20;
    }else;
    ...
    {
      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b10) = 1;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b11) = 0;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b12) = 1;
      sum += _acc_adc.y;
      count++;
      axis_to_cali_flag = 1;
      step = 2;
    ...
    {
      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b10) = 1;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b11) = 1;      (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR)))->b12) = 0;
      sum += _acc_adc.z;
      count++;
      axis_to_cali_flag = 2;
      step = 4;
    ...
    if(count>1000)
    {
      if(sum<0)
      {
        acc_min[axis_to_cali_flag] = sum/1000;
        end_min_of_axis[axis_to_cali_flag] = 0;
        count = 0;
      }
      else
      {
        acc_max[axis_to_cali_flag] = sum/1000;
...
short x_min = 0,x_max = 0,y_min = 0,y_max = 0,z_min = 0,z_max = 0;
