...
void IIC_Port_Init(void)
{
  gpio_init(PB6,GPIO_Mode_Out_OD,n_interupt,GPIO_Speed_50MHz,1);						 
  gpio_init(PB7,GPIO_Mode_Out_OD,n_interupt,GPIO_Speed_50MHz,1);						 
}
...
BOOL Single_Write(uint8 slave_addr, uint8 reg_addr, uint8 data)		     
{
  IIC_Start();                  
