...
uint8 nrf_init(nrf_mode_e _nrf_mode_e)
{
  ...
  gpio_init(PA8, GPIO_Mode_IPU, interupt,GPIO_Speed_50MHz,0);                              
  gpio_int_cfg(PA8,((uint32_t)0x00100),EXTI_Trigger_Falling);
...
uint8 nrf_writereg(uint8 reg, uint8 dat)
{
  ...
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 0;
  spi_mosi(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), buff, buff, 2); 
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 1;
...
{
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 0;
  spi_mosi_cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), &reg , &reg, pBuf, 0, 1 , len); 
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 1;
  return reg;    
}
...
{
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 0;
  spi_mosi_cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), &reg , &reg, 0, pBuf, 1 , len); 
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 1;
...
uint8 nrf_link_check(void)
{
  ...
  reg = 0x20 + 0x10;
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 0;
  spi_mosi_cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), &reg, 0 , buff, 0, 1 , 5); 
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 1;
  
  delay_us(100);
  reg = 0x10;
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 0;
  spi_mosi_cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), &reg, 0 , 0, buff, 1 , 5); 
  (((_32type*)(&(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR)))->b4) = 1;
