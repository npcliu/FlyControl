...
uint8 compassbuff[2] = {0};            
  compassbuff[0] = Single_Read(0x1A, 0x00);
  compassbuff[1] = Single_Read(0x1A, 0x01);
  pcompass[0] = ((compassbuff[1]<<8)|compassbuff[0]);
  compassbuff[0] = Single_Read(0x1A, 0x02);
  compassbuff[1] = Single_Read(0x1A, 0x03);
  pcompass[1] = ((compassbuff[1]<<8)|compassbuff[0]);
  compassbuff[0] = Single_Read(0x1A, 0x04);
  compassbuff[1] = Single_Read(0x1A, 0x05);
