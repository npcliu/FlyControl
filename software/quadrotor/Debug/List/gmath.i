        ...
        )
{
    ...
    ((from_pos != 0) ? (void)0 : ( __aeabi_assert("from_pos != 0", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\nmealib\\src\\gmath.c", 120), ( __iar_EmptyStepPoint())));
    ((to_pos != 0) ? (void)0 : ( __aeabi_assert("to_pos != 0", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\nmealib\\src\\gmath.c", 121), ( __iar_EmptyStepPoint())));
    ...
    )
{
    ...
    ((start_pos != 0) ? (void)0 : ( __aeabi_assert("start_pos != 0", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\nmealib\\src\\gmath.c", 270), ( __iar_EmptyStepPoint())));
    ((end_pos != 0) ? (void)0 : ( __aeabi_assert("end_pos != 0", "E:\\Elec\\Air plane\\FlyCtrl\\CTRL_PCBV5\\nmealib\\src\\gmath.c", 271), ( __iar_EmptyStepPoint())));
