...
COMPASS compass = {.x_offset = 39,.y_offset=-486,.z_offset=253};        
COMPASS LSM_compass = {.x_offset = 0,.y_offset=0,.z_offset=0};

uint8 pipl_dir;             
float acc_angle[2][3] = {0};    
int  temperature;
int  pressure;
float bat_voltage = 0;          
float gc[4][8] = {0};
...
int main(void)
{
  ...
  gpio_init(PC11,GPIO_Mode_Out_PP,n_interupt,GPIO_Speed_50MHz,1);						 
  gpio_init(PC12,GPIO_Mode_Out_PP,n_interupt,GPIO_Speed_50MHz,1);					 
  gpio_init(PB0,GPIO_Mode_Out_PP,n_interupt,GPIO_Speed_50MHz,0);						 
  gpio_init(PC5,GPIO_Mode_Out_PP,n_interupt,GPIO_Speed_50MHz,1);						 
  gpio_init(PB8, GPIO_Mode_Out_PP,n_interupt,GPIO_Speed_50MHz, 1);                               
  ...
  TIM3_PWM_Init(50,10000,0);                    
  TIM_SetCompare4(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),900);  
  ...
  if(nrf_init(RX_MODE))                         
    while(1);
  (((_32type*)(&(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))->CR1)))->b6) = 0; (((_32type*)(&(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))->CR1)))->b1) = 1; (((_32type*)(&(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))->CR1)))->b0) = 1; (((_32type*)(&(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))->CR1)))->b6) = 1;;                 
