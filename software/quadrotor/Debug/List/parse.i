...
int nmea_pack_type(const char *buff, int buff_sz)
{
    ...
    ((buff) ? (void)0 : ( __aeabi_assert("buff", "E:\\FlyCtrl\\bmp180_test\\quadrotor\\nmealib\\src\\parse.c", 110), ( __iar_EmptyStepPoint())));
...
int nmea_find_tail(const char *buff, int buff_sz, int *res_crc)
{
    ...
    ((buff && res_crc) ? (void)0 : ( __aeabi_assert("buff && res_crc", "E:\\FlyCtrl\\bmp180_test\\quadrotor\\nmealib\\src\\parse.c", 143), ( __iar_EmptyStepPoint())));
...
int nmea_parse_GPGGA(const char *buff, int buff_sz, nmeaGPGGA *pack)
{
    ...
    ((buff && pack) ? (void)0 : ( __aeabi_assert("buff && pack", "E:\\FlyCtrl\\bmp180_test\\quadrotor\\nmealib\\src\\parse.c", 190), ( __iar_EmptyStepPoint())));
...
void nmea_GPGGA2info(nmeaGPGGA *pack, nmeaINFO *info)
{
    ((pack && info) ? (void)0 : ( __aeabi_assert("pack && info", "E:\\FlyCtrl\\bmp180_test\\quadrotor\\nmealib\\src\\parse.c", 377), ( __iar_EmptyStepPoint())));
