...
void PIT3_Init(uint32 nms)
{
  ...
  TIM_TimeBaseStructure.TIM_Period = nms;		        
  TIM_TimeBaseStructure.TIM_Prescaler = 32768;		        
...
void TIM1_PWM_Init(uint32 freq, float duty)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000800) | ((uint32_t)0x00000040) | ((uint32_t)0x00000001), ENABLE);
  
  GPIO_PinRemapConfig(((uint32_t)0x001600C0), ENABLE); 
  
  TIM_TimeBaseInitStruct.TIM_Period = ((30000<1000 && 30000>0)*(uint32)(48e6/(30000<<2))+(30000>=1000 && 30000<100000)*(uint32)(48e6/(30000<<1))+(30000>=100000)*(uint32)(48e6/30000))-1;  
  TIM_TimeBaseInitStruct.TIM_Prescaler = prescaler;   
  TIM_TimeBaseInitStruct.TIM_ClockDivision = 0;
  TIM_TimeBaseInitStruct.TIM_CounterMode = ((uint16_t)0x0000);
  TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), &TIM_TimeBaseInitStruct);
  
  TIM_OCStructInit(&TIM_OCInitStruct); 
  
  TIM_OCInitStruct.TIM_OCMode = ((uint16_t)0x0060);
  TIM_OCInitStruct.TIM_OutputState = ((uint16_t)0x0001);
  TIM_OCInitStruct.TIM_Pulse = (uint32)(((30000<1000 && 30000>0)*(uint32)(48e6/(30000<<2))+(30000>=1000 && 30000<100000)*(uint32)(48e6/(30000<<1))+(30000>=100000)*(uint32)(48e6/30000))*duty);
  TIM_OCInitStruct.TIM_OCPolarity = ((uint16_t)0x0000);
  TIM_OC1Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), &TIM_OCInitStruct);
  TIM_OC2Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), &TIM_OCInitStruct);
  TIM_OC3Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), &TIM_OCInitStruct);
  
  TIM_OC1PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((uint16_t)0x0008));     
  TIM_OC2PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((uint16_t)0x0008));     
  TIM_OC3PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((uint16_t)0x0008));     
  
  TIM_ARRPreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ENABLE);
